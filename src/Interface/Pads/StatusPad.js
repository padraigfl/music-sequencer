...
const StatusCell = styled('div')`
  ...
  &.red {
    box-shadow: 0px 0px 0px 1px #222, 0px 0px 1px 5px #008800, 0px 0px 4px 7px #FF0000;
  }
  &.red.green {
    box-shadow: 0px 0px 0px 1px #222, 0px 0px 1px 5px #00FF00, 0px 0px 4px 7px #FF0000;
  }
`;
